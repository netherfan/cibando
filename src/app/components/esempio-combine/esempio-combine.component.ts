...
export class EsempioCombineComponent {
  nomi1 = [{name: 'Danilo'}, {name: 'Carlo'}, {name: 'Mario'}];
	...
	ngOnInit(): void {
		forkJoin(this.primoGruppo$, this.secondoGruppo$, this.terzoGruppo$).subscribe(res => this.gruppi = res);
	}
}
